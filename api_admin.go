...
func (r ApiModelsCountRequest) Execute() (*ModelCountResponse, *http.Response, error) {
	return r.ApiService.ModelsCountExecute(r)
}
...
func (a *AdminAPIService) ModelsCountExecute(r ApiModelsCountRequest) (*ModelCountResponse, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ModelCountResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminAPIService.ModelsCount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/admin/models/count"
...
func (a *AdminAPIService) VersionExecute(r ApiVersionRequest) (*VersionResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminAPIService.Version")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
